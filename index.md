...
instructor: ["Katerina Michalickova", "Saranjeet Kaur Bhogal", "Diego Alonso Álvarez", "Katie Buntic"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Mehmet Bozkurt", "Maria Broadbridge", "Chris Cave-Ayland", "Jeremy Cohen", "Jack Coker", "Dan Davies", "Andrew Gait", "Stefano Galvan", "Will Graham", "Liz Ing-Simmons", "Jost Migenda", "Steph Wills", "Fiona Young"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["info@step-up.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
